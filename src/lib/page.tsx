    ...
    <div>
      <div className="flex items-center justify-between print:hidden">
        ...
        <div className="flex gap-2">
          <a href={`/api/contratos/${id}/estado-cuenta/excel`} className="rounded-md border border-slate-300 px-3 py-1.5 text-sm text-slate-600 hover:bg-slate-100">
            Descargar Excel
          </a>
          <a href={`/api/contratos/${id}/estado-cuenta/pdf`} className="rounded-md border border-slate-300 px-3 py-1.5 text-sm text-slate-600 hover:bg-slate-100">
            Descargar PDF
          </a>
          <PrintButton />
        </div>
